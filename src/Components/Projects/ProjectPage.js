...
class ProjectPage extends React.Component {
     ...
     <div className='project-div'>
      ...
      <Container className="project-container">
        <Jumbotron className="project-jumbo" fluid>
            <Container>
            <h1 className ="project-subtitle">MadGiraffestudios</h1>
            <Row>
                    <Col lg={6}> 
                        <Image  className='project-image' src={MadGiraffestudios} thumbnail/> 
                    </Col>
 ...
 <Container className="project-container">
        <Jumbotron className="project-jumbo" fluid>
            <Container>
            <h1 className ="project-subtitle">Atmosphere</h1>
            <Row>
                    <Col lg={6}> 
                        <Image  className='project-image' src={Atmosphere} thumbnail/> 
                    </Col>
...
<Container className="project-container">
        <Jumbotron className="project-jumbo" fluid>
            <Container>
            <h1 className ="project-subtitle">Pace GPS</h1>
                <Row>
                    <Col lg={6}> 
                        <Image  className='project-image'  src={PaceGPS} thumbnail/> 
                    </Col>
